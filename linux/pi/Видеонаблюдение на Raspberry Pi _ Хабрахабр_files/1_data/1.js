...
if (http && cid && (cookieaction == 1 || cookieaction == 3) && document.cookie.indexOf('ar_etw') == -1){
		...
		document.write('<img src="//mat'+'ch.ads.betweendigital.com/match?bidder_id=3&external_user_id='+encodeURIComponent(cid)+'&c=0">');
}
if (tns == 1){
...
if (cid && cookiestate == 0 && document.cookie.indexOf('ar_kvn') == -1){
		...
		document.write('<img src="//sp'+'b.bid.run/sync/adriver.gif?ssp_uid='+encodeURIComponent(cid)+'">');
}
if (cid && cookiestate == 0 && document.cookie.indexOf('ar_au') == -1){
		sC('ar_au', 1, 1000*60*60*24);
		document.write('<img src="//sy'+'nc.audtd.com/match/adriver?uid='+encodeURIComponent(cid)+'">');
}
...
if (cookieaction == 4 || cookieaction == 5 || cookieaction == 6 || cookieaction == 7 || cookieaction == 8){
		...
		cid && document.write('<img src="//sy'+'nc.madnet.ru/image?source=adriver&id='+encodeURIComponent(cid)+'&return_url='+("https:" == document.location.protocol ? "https" : "http")+'%3A%2F%2Fssp.adriver.ru%2Fcgi-bin%2Fsync.cgi%3Fdsp_id%3D105%26external_id%3D%7BUID%7D">');
		cid && document.write('<img src="//sync-e'+'u.exe.bid/image?source=adriver&id='+encodeURIComponent(cid)+'&return_url='+("https:" == document.location.protocol ? "https" : "http")+'%3A%2F%2Fssp.adriver.ru%2Fcgi-bin%2Fsync.cgi%3Fdsp_id%3D106%26external_id%3D%7BUID%7D">');
		document.write('<img src="//ssp.t'+'ds.io/merge/adriver">');
		cid && document.write('<img src="//t.ins'+'igit.com/fd1e81207946c410778a32b4aa439178/1126f8517f0ec19723abe43ad7e09415/?event=info&uid='+encodeURIComponent(cid)+'">');
		document.write('<img src="//fro'+'nt.sspicy.ru/collect?sync_redirect=sspicy_adriver">');
		cid && document.write('<img src="//p.tp'+'m.pw/sync?ssp=363616&m=r&extid='+encodeURIComponent(cid)+'">');
		document.write('<img src="//trac'+'ker.rareru.ru/match?bidder_id=adriver">');
		cid && document.write('<img src="https://sy'+'nc.1dmp.io/pixel.gif?cid=7287fde7-f83f-4ff9-ace2-07c8fef0a289&pid=w&uid='+encodeURIComponent(cid)+'">');
		cid && document.write('<img src="//www.a'+'vito.ru/stat/match?uid='+encodeURIComponent(cid)+'&token=65bcc445a28d5565e70bb751c084780508b78862">');
		document.write('<img src="//dmp.m'+'indshare.1dmp.io?cid=170e8600-7dac-4112-8ca9-a5cb6d23d301&pid=tm.cview&ru=%2F%2Fssp.adriver.ru%2Fcgi-bin%2Fsync.cgi%3fdsp_id%3D135%26external_id%3D%5BUID%5D">');
