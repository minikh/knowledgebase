...
//    private FacadeBeanRemote f;
    ...
    @EJB
    private FacadeStateFullBeanLocal facadeStateFull;
...
//    }
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        PrintWriter out = resp.getWriter();
        out.print("<html>");
        out.print("<hr/>S1 сервлет. Service");
...
//        out.print("<hr/>" + f.info());
//        f.startJob();
        out.print("<br>Задание работает");

        facadeStateFull.info();
        facadeStateFull.myRemove();
