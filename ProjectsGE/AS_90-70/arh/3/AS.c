...
static float dPd_max, Time_PD, CV_PD, dPs_max, Time_PS, CV_PS,NumHlop;
...
POC(0, ON_GUARD,PD_OF, P_OUT, SpeedUP_Pd_TS, P_OUT_F, Usl_OF, SpeedUP_dPd, SpeedUP_Pd_Ku,CVRegSpeed,
...
POC(1, ON_GUARD,PS_OF, P_IN, SpeedDN_Ps_TS, P_IN_F, Usl_OF, SpeedDN_dPs, SpeedDN_Ps_Ku,CVRegSpeed,
...
OUTb[11]= P_out_Act;
OUTb[12]= Rc_Act;
OUTb[13]= as_MStruct.pid_struct[2].active;
OUTb[14]= as_MStruct.pid_struct[3].active;
