...
static short dRT, dRT1,dRT_On,dSO,end_RT,RTvar2,Produv,up_CV,up_CV1,end_PD,end_PS,OnTimRT1;
...
static float dPd_max[2], Time_PD, CV_PD, dPs_max[2], Time_PS, CV_PS,NumHlop,OnTimRT,P_IN1,P_OUT1;
