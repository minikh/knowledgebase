...
MASS(Q_OK,NST,Pin,Pout,/*P_IN,P_OUT*/T_IN,dP,pl_g,B, //Входы
...
POC(0, ON_GUARD,PD_OF, Pout/*P_OUT*/, &P_OUT1, SpeedUP_Pd_TS, P_OUT_F, Usl_OF, SpeedUP_dPd, SpeedUP_Pd_Ku,CVRegSpeed,
...
///POC Ps
//POC(PS, ON,OFF,IN, TS, IN_F, Usl_OF, SpeedUP_dP, SpeedUP_P_Ku,CVRegSpeed,*dP_max, *MA_AS, *POC_P, *Time, *end_POC, *CV_P,*POC_P_On1);
POC(1, ON_GUARD,PS_OF, Pin/*P_IN*/, &P_IN1, SpeedDN_Ps_TS, P_IN_F, Usl_OF, SpeedDN_dPs, SpeedDN_Ps_Ku,CVRegSpeed,
...
OUTb[1] |= as_MStruct.pid_struct[3].active;
OUTb[1] |= 1<<13;
OUTb[1] |= 1<<15;
