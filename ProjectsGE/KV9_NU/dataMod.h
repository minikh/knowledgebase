...
#define NvdToNnd *ukaz,707,721
#define Nvd0ToA6 *ukaz,722,726
#define YdusMainToGt *ukaz,727,728
#define TtstartToNvd *ukaz,729,751
#define PkstartToNvd *ukaz,752,773
#define NststartToNvd *ukaz,774,795
#define Nvd0ToTst0 *ukaz,796,806
#define MktoNvd *ukaz,807,913
#define KdtoNvd *ukaz,914,1071
#define Gt0ToNvd0 *ukaz,1072,1081
#define Nvd0ToGt0 *ukaz,1082,1091
#define MstToNvd0 *ukaz,1092,1101
#define ZsVSToNvd0 *ukaz,1102,1227
#define Gt0startToNvd0 *ukaz,1228,1353
#define Nvd0ToPow *ukaz,1354,1363
#define Nvd0ToTt0 *ukaz,1364,1373
#define Nvd0ToPk0 *ukaz,1374,1383
#define Nvd0ToTauvd0 *ukaz,1384,1393
#define Nvd0ToA1 *ukaz,1394,1403
#define Nvd0ToA2 *ukaz,1404,1413
#define Nvd0ToA3 *ukaz,1414,1423
#define Nvd0ToA4 *ukaz,1424,1428
#define Nvd0ToA5 *ukaz,1429,1433
#define NvdToNnd *ukaz,1434,1448
#define Nvd0ToA6 *ukaz,1449,1453
// колличество точек в массиве = 1454
// колличество листов табличных данных = 46
...
{0.0,0.0,0.1953125},
{5120.0,1000.0,0.25839793},
{8990.0,2000.0,0.53030303},
{10310.0,2700.0,1.18466667},
{10400.0,2806.62,0.8917},
{10540.0,2931.458,0.82519091},
{10760.0,3113.0,1.52336449},
{10867.0,3276.0,1.82729032},
{10960.0,3445.938,1.2779719},
{11100.23,3625.148,0.64472955},
{11255.34,3725.152,0.90939478},
{11413.3,3868.8,1.03597468},
{11544.42,4004.637,1.20043501},
{11661.66,4145.376,0.95774905},
{11776.9,4255.747,0.36136394},
{0.0,0.0,0.0},
{8000.0,0.0,-0.001875},
