...
main(/*Входы*/float *IN_Ro_s, float *IN_X_a, float *IN_X_u, float *IN_Dcu_20, float *IN_D_20, float *IN_R_sh, float *IN_Alfa_cu,float *IN_Alfa_t, float *IN_r_n, float *IN_Tau_t, float *IN_t, float *IN_P_iz, float *IN_P_at, float *IN_dP, unsigned int *IN_ContractTime, int *IN_dP_F, /*Выходы*/float *raschet_q_c, float *raschet_q_v, float *raschet_q_m, int *raschet_Fault, unsigned int *raschet_Error)
{
