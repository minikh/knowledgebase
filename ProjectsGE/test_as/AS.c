...
///***************************************************** main **********************************************************
void GefMain(/*Входы*/IN, INb,
			/*Константы*/ Const,
			/*Линии регулирования*/ Line,
			/*Выходы*/ OUT,OUTb,oLine,
...
float  Rc,Q_pr,Q,KySpeedMax,dSP_Kd;
...
Pin_SpeedLim= Const[63];
Pout_SpeedLim= Const[64];
...
MASS(Q_OK,NST,Pin,Pout,T_IN,dP,pl_g,B, //Входы
...
Temp_F[20]= as_MStruct.pid_struct[1].PV;
Temp_F[19]= as_MStruct.pid_struct[1].act_SP;
Temp_F[18]= as_MStruct.pid_struct[1].err;
Temp_F[17]= as_MStruct.pid_struct[1].P_part;
//Temp_F[16]= 0;

Temp_F[25]= as_MStruct.pid_struct[2].PV;
Temp_F[24]= as_MStruct.pid_struct[2].act_SP;
Temp_F[23]= as_MStruct.pid_struct[2].err;
Temp_F[22]= as_MStruct.pid_struct[2].P_part;
//Temp_F[21]= 0;

Temp_F[30]= as_MStruct.pid_struct[3].PV;
Temp_F[29]= as_MStruct.pid_struct[3].act_SP;
Temp_F[28]= as_MStruct.pid_struct[3].err;
Temp_F[27]= as_MStruct.pid_struct[3].P_part;
//Temp_F[26]= 0;

Temp_F[34]= as_MStruct.loop_selected;
Temp_F[35]= as_MStruct.cv;
Temp_F[36]= as_MStruct.dI_selected; 
