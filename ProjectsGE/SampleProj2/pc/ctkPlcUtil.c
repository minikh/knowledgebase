...
*************************************************************************/
/*************************************************************************
 * Module $Id: ctkPlcUtil.c,v 1.4 2010/08/05 14:27:48 mummids1 Exp $
 *************************************************************************/
/******************************************************************************
`ModuleName ctkPlcUtil.c
` This include file contains stub implementations of Utility 
` PLC Target Library functions which is used for debugging on the PC.
`
*******************************************************************************/
/* IncludeFiles */
#include "ctkPlc.h"
...
/* Routines */
/******************************************************************************
`Proc PLCC_Crc16Checksum
` See ctkPlcUtil.h for a description of this function.
*******************************************************************************/
T_WORD PLCC_Crc16Checksum(T_BYTE *pFirstByte, T_DWORD length, T_WORD currentCrcValue)
{
	int i;
	
	/*` Calculate a CRC-16 across the frame */
	for ( i = 0; i < length; i++ ) 
	{
		currentCrcValue = crc16_tbl[(currentCrcValue ^ *pFirstByte++) & 0xFF] ^ 
		                  (currentCrcValue >> 8);
	}
